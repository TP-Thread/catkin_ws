...
"""autogenerated by genpy from ros_msg/gps.msg. Do not edit."""
import codecs
import sys
...
class gps(genpy.Message):
  _md5sum = "2e88afedde78d4bdbbd4ecab4923992f"
  _type = "ros_msg/gps"
...
float64 w
"""
  __slots__ = ['state','x','y','pose']
  _slot_types = ['string','float32','float32','geometry_msgs/PoseStamped']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2f3I().pack(_x.x, _x.y, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.x, _x.y, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs,) = _get_struct_2f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
