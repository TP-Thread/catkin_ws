...
"""autogenerated by genpy from action_demo/DoDishesActionResult.msg. Do not edit."""
import codecs
import sys
...
class DoDishesActionResult(genpy.Message):
  _md5sum = "61019e447a1d83a4fa7410860a41f245"
  _type = "action_demo/DoDishesActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_demo/DoDishesResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DoDishesActionResult, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.result.total_dishes_cleaned
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.total_dishes_cleaned,) = _get_struct_I().unpack(str[start:end])
      return self
