...
class DoDishesActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = DoDishesFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DoDishesActionFeedback(null);
    ...
    data.feedback = DoDishesFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DoDishesActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = DoDishesFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new DoDishesFeedback()
    }
...
module.exports = DoDishesActionFeedback;
